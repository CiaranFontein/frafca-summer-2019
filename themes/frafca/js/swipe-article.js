(function ($) {
    ...
    function createSwipeContainer($obj) {
        $obj.each(function(index){
            ...
            $(this).html('<div class="swipe-wrapper"></div><div class="navigation-dots"></div>');
        ...
        function fxDetect(){
            ...
            $scrollObj.children().filter((index, value) => {
                ...
                if ( Math.abs($findActiveObj) < $(value).width() ){
                    ...
                    $obj.find('.dot').eq(index).addClass('active');
    ...
    function setActiveEleHeight($obj, index = 0){
        ...
        $obj.each(function(){
            ...
            $(this).children('.swipe-wrapper').height( $activeObj.outerHeight( true ) );
        })
