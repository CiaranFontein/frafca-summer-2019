...
<div class="tribe-events-meta-group tribe-events-meta-group-venue single-event-venue">
	<h2 class="tribe-events-single-section-title single-event-venue-title"> <?php esc_html_e( tribe_get_venue_label_singular(), 'the-events-calendar' ) ?> </h2>
	<dl>
