    ...
    <div class="footer-container">
        <div class="footer-nav-container">
            ...
            <nav id="footer-site-whatwedo" class="footer-navigation" role="navigation">
                <div class="footer-menu-trigger">
                    <div class="footer-menu-header" aria-controls="footer-menu" aria-expanded="false">
                        <?php echo esc_html( 'What We Do' ); ?></div>
            ...
            <nav id="footer-site-involved" class="footer-navigation" role="navigation">
                <div class="footer-menu-trigger">
                    <div class="footer-menu-header" aria-controls="footer-menu" aria-expanded="false">
                        <?php echo esc_html( 'Get Involved' ); ?></div>
                    <div class="footer-arrow-down-icon"><i class="fas fa-angle-down"></i></div>
                </div>
                <div class="footer-menu-container">
        ...
        <div class="logo-social-container">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
                <img src="<?php echo get_template_directory_uri() . '/images/logos/2018_frafca_logo_final.png'; ?>"
                    class="footer-logo-img" alt="FRAFCA logo " />
            </a>
